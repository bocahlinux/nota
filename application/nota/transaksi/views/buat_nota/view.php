	        	...
	        	<div class="box-body">
			      		...
			      		<div class="col-md-8">
				      		<div class="form-group">
							      ...
							      <div class="col-md-2">
							      	<input type="text" class="form-control" id="kd_transaksi" name="kd_transaksi" value="<?php echo $kd_tr ?>" readonly="readonly">
										...
										<label class="control-label col-md-3" for="tgl_transaksi">Tanggal Transaksi :</label>
										<div class="col-md-3">
									  	<input type="text" class="form-control" id="tgl_transaksi" name="tgl_transaksi" value="<?= gmdate('d-m-Y H:i:s',time()+3600*7) ?>" readonly="readonly">
								    </div>
							    </div>
						    ...
						    <div class="form-group">
						      ...
						      <div class="col-md-3">
						        <input list="list_barang" class="form-control reset" placeholder="Kode Barang..." name="kd_brg" id="kd_brg" autocomplete="off" onKeyPress="showBarang(this.value)" autofocus>
	                  <datalist id="list_barang">
	                  	<?php foreach ($barang as $barang): ?>
	                  		<option value="<?= $barang->kd_brg ?>"><?= $barang->nm_brg ?></option>
		                  	<?php endforeach ?>
	                  </datalist>
						      </div>
						    </div>
						    ...
						    <div class="form-group">
										...
										<input type="hidden" class="form-control" name="kd_transaksi" value="<?php echo $kd_tr ?>" readonly="readonly">



										<input type="hidden" class="form-control" name="tgl_transaksi" value="<?= date('d-m-Y') ?>" readonly="readonly">
	...
	function showBarang(str)
	{
	    if (str == "") {
	      ...
	      xmlhttp.open("GET", "<?php echo base_url(
	      	'transaksi/nota_penjualan/getbarang')?>/"+str,true);
	      xmlhttp.send();
				$('#qty').focus();
    ...
    $(document).ready(function() {
        ...
        if($("#total").val()=='0'){
            ...
            return false();
				...
				window.open('<?php echo base_url();?>transaksi/nota_penjualan/cetak_penjualan/'+$("#kd_transaksi").val());
