					...
					<form class="form-horizontal" id="form_transaksi" role="form">
			      		<div class="col-md-8">
				      		<div class="form-group">
								...
								<div class="col-md-2">
									<input type="text" class="form-control" id="kd_transaksi" name="kd_transaksi" value="<?php echo $kd_svc; ?>" readonly="readonly">
								</div>
							</div>
						    <div class="form-group">
								...
								<div class="col-md-7">
									<select autofocus class="form-control select2" data-placeholder="Cari Barang ...." name="kd_brg" id="kd_brg" >
										...
										<?php foreach ($kd_service as $kd_service): ?>
										<option value="<?= $kd_service->kd_service ?>">
											[
											<?= $kd_service->kd_service
											."] ".
											$kd_service->nm_service ?></option>
										<?php endforeach ?>
									</select>
								</div>
						    </div>
						    ...
						    <div class="form-group">
										...
										<input type="hidden" class="form-control" id="hid_kd_transaksi" name="hid_kd_transaksi" value="<?php echo $kd_svc ?>" readonly="readonly">
...
$(function () {
	...
	function showBarang(str)
	{
	    if (str == "") {
	      ...
	      xmlhttp.open("GET", "<?php echo base_url('transaksi/nota_service/getbarang')?>/"+str,true);
	      xmlhttp.send();
				$('#qty').focus();
