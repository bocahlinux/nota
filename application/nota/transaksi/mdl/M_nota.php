...
defined('BASEPATH') OR exit('No direct script access allowed');
	...
	class M_nota extends CI_Model {
		var $column = array('kd_transaksi','tgl_transaksi','kd_pelanggan','total','bayar','ket_transaksi');
		var $order = array('kd_transaksi' => 'asc');
		var $table  = 'tbl_penjualan_header';
		...
		{
			$this->db->from('tbl_penjualan_header');
